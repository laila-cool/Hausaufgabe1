...
public class GameFrame extends JFrame{
	...
	public void setGameObjects(final LinkedList<IGameObject> gameObjects) {
		SwingUtilities.invokeLater(new Runnable() {
	...
	public void setImageObjects(final LinkedList<Image> imageObjects) {
		SwingUtilities.invokeLater(new Runnable() {
	...
	public void setGameShapes(final LinkedList<Shape> gameShapes) {
		SwingUtilities.invokeLater(new Runnable() {
	...
	public void addBackground(final IBackground background) {
		SwingUtilities.invokeLater(new Runnable() {
